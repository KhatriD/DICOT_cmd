...
%
%   [TRACKS, OBJECT_NUM, TRACK_MATRIX] = DICOT_TRACKING(OUTFOLDER, STATS, SEARCH_RADIUS, SCALING_FACTOR, INTERVAL, MINIMUM_TRACK_INTERVAL) links objects based on nearest neighbouring method to generate tracks. Returns the following parameters,
